...
public:                                 //Public members.
    ...
    void set_code(string x)
    {
        code=x;   //Getting & setting value.
    }
    string get_code()
    {
        return code;
...
public:                                         //Public members.
    ...
    void set_flavour(string y)
    {
        flavour=y;   //Getting & setting value.
    }
    string get_flavour()
    {
        return flavour;
    ...
    void show()
    {
        cout<<left<<setw(15)<<get_code()<<right<<setw(17)<<get_name()<<right<<setw(16)<<get_price()<<right<<setw(20)<<get_quantity()<<right<<setw(16)<<get_flavour()<<right<<setw(28)<<get_n_facts()<<"\n";   //Display values.
    }
};
...
public:                                             //Public members.
    ...
    {
        colour=x;   //Getting & setting value.
    }
    string get_colour()
    {
        return colour;
    ...
    void set_m_company(string y)
    {
        m_company=y;
    }
    string get_m_company()
    {
        return m_company;
    }
    ...
    void show()
    {
        cout<<left<<setw(15)<<get_code()<<right<<setw(17)<<get_name()<<right<<setw(16)<<get_price()<<right<<setw(20)<<get_quantity()<<right<<setw(16)<<get_colour()<<right<<setw(28)<<get_m_company()<<"\n";   //Display values.
    }
} ;
